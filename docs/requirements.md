...
| サービス | multi_select | ペットOK／子連れOK／テラス席あり／テイクアウト／24h営業／個室ブース／窓際席あり／デカフェあり／モニター貸出あり／充電器貸出あり／ブランケット貸出あり | 利用シーン拡張。 |
...
| 適した作業 | multi_select | PC作業／読書／勉強／打合せ | 利用シーン訴求。 |
